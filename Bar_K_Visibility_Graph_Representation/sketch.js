...
//preloading icons
function preload(){
	pencil = loadImage("Bar_K_Visibility_Graph_Representation/pencilIcon.png");
	reload = loadImage("Bar_K_Visibility_Graph_Representation/reloadIcon.png");
	_cursor = loadImage("Bar_K_Visibility_Graph_Representation/cursorIcon.png");
}
